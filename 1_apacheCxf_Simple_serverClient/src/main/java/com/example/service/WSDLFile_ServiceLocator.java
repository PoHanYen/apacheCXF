...
public class WSDLFile_ServiceLocator extends org.apache.axis.client.Service implements com.example.service.WSDLFile_Service {
    ...
    private java.lang.String WSDLFileSOAP_address = "http://localhost:8081/spring_Cxf_Soap_server/services/WSDLFileSOAP";
    ...
    public com.example.service.WSDLFile_PortType getWSDLFileSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.service.WSDLFileSOAPStub _stub = new com.example.service.WSDLFileSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.service.WSDLFile_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.service.WSDLFileSOAPStub _stub = new com.example.service.WSDLFileSOAPStub(new java.net.URL(WSDLFileSOAP_address), this);
                _stub.setPortName(getWSDLFileSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.example.com/", "WSDLFile");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.example.com/", "WSDLFileSOAP"));
        }
